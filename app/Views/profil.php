    ...
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <span class="subheading">Apik Mandiri's Project</span>
                <h2>Kolaborasi & Harapan</h2>
                <h2>Untuk Semua</h2>
            </div>
        </div>
        <div class="row">
...
<section class="ftco-section">
    <div class="container">
        <div class="row justify-content-center">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Alamat:</span>Jl. Darussalam No.79, Susunan Baru, Kec. Tj. Karang Bar., Kota Bandar Lampung, Lampung 35115</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Email:</span> <a href="mailto:apikmandiri@gmail.com">apikmandiri@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="col-md-12">
                <div class="mapouter">
                    <div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Jl. Darussalam No.79, Susunan Baru, Kec. Tj. Karang Bar., Kota Bandar Lampung, Lampung 35115&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://connectionsgame.org/">Connections Game</a></div>
                    <style>
                        .mapouter {
                            position: relative;
                            text-align: right;
                ...
                <div class="carousel-testimony owl-carousel">
                    <div class="item">
                        <div class="testimony-wrap d-flex">
                            <div class="user-img" style="background-image: url(/unicare-master/images/kitabisa_icons_512.png)">
                            </div>
                            <div class="text pl-4">
